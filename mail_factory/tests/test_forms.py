...
class FormTest(TestCase):
    def test_init_initial(self):
        ...
        self.assertEqual(MailForm(initial={"foo": "bar"}).initial["foo"], "bar")
        # with Meta
        ...
        self.assertEqual(TestForm(initial={"content": "foo"}).initial["content"], "foo")
    ...
    def test_get_context_data(self):
        ...
        self.assertEqual(MailForm().get_context_data(foo="bar")["foo"], "bar")
