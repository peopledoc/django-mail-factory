...
class MailTest(TestCase):
    ...
    def test_get_context_data(self):
        ...
        self.assertEqual(TestMail().get_context_data(foo="bar"), {"foo": "bar"})
    ...
    def test_get_template_part(self):
        ...
        test_mail.lang = "foo"
        self.assertEqual(
            test_mail.get_template_part("stuff"),
            ["mails/test/foo/stuff", "mails/test/stuff"],
        )
        self.assertEqual(
            test_mail.get_template_part("stuff", "bar"),
    ...
    def test_render_part(self):
        ...
        self.assertEqual(
            test_mail._render_part("subject.txt"), "[TestCase] Mail test subject"
        )
        ...
        test_mail.lang = "not a lang"
        self.assertEqual(
            test_mail._render_part("subject.txt", "en"), "[TestCase] Mail test subject"
        )
        self.assertEqual(test_mail._render_part("body.txt", "fr"), "Français")
        # if provided language doesn't exist, fallback
        self.assertEqual(
            test_mail._render_part("subject.txt", "not a lang"),
    ...
    def test_create_email_msg(self):
        ...
        self.assertEqual(
            test_mail.create_email_msg([]).from_email, settings.DEFAULT_FROM_EMAIL
        )
        ...
        self.assertEqual(msg.extra_headers["Reply-To"], settings.DEFAULT_FROM_EMAIL)
    ...
    def test_no_reply(self):
        ...
        self.assertIn("Reply-To", msg.extra_headers)
        self.assertEqual(msg.extra_headers["Reply-To"], settings.NO_REPLY_EMAIL)
