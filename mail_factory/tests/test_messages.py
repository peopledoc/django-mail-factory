...
class EmailMultiRelatedTest(TestCase):
    ...
    def test_attach_related_non_mimebase(self):
        ...
        self.message.attach_related(filename="foo", content="bar", mimetype="baz")
        self.assertEqual(self.message.related_attachments, [("foo", "bar", "baz")])
    ...
    def test_create_alternatives(self):
        ...
        self.assertEqual(
            self.message.alternatives, [('<img src="cid:img.gif" />', "text/html")]
        )
